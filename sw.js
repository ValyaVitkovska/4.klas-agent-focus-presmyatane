const CACHE_NAME='agent-focus-v10';
const ASSETS=['./','./index.html','./manifest.webmanifest','./assets/agent-focus.png','./assets/agent-focus-portrait.png','./assets/valya-logo.png','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-maskable-512.png'];
